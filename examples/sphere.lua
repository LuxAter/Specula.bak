...
m:set_type(Material.Type.DIFFUSE)
camera:eye(0.0, 0.0, 9.0)
Sphere.new(1.0):set_material(m):translate(0.0, 0.0, 0.0)
...
Plane.new(0.0, -1.0, 0.0, 1.0):rotate_z(-math.pi/2):translate(10.0, 0.0, 0.0):set_material(m)
Plane.new(0.0, -1.0, 0.0, 1.0):rotate_z(math.pi/2):translate(-10.0, 0.0, 0.0):set_material(m)
Plane.new(0.0, -1.0, 0.0, 1.0):rotate_z(0.0):translate(0.0, 10.0, 0.0):set_material(m)
Plane.new(0.0, -1.0, 0.0, 1.0):rotate_x(-math.pi/2):translate(0.0, 0.0, -10.0):set_material(m)
Plane.new(0.0, -1.0, 0.0, 1.0):rotate_x(math.pi/2):translate(0.0, 0.0, 10.0):set_material(m)
